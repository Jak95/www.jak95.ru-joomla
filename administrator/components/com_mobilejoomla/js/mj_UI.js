...
window.addEvent('domready',function(){
	...
	function checkupdate(){
		if(typeof Request == "function"){
			new Request.HTML( {
				url: 'http://www.mobilejoomla.com/getver.php?v=' + escape('1.0.2'),
				method: 'get',
				update: 'mjlatestver',
				onSuccess : function(tree, elements, response){
					if(version_compare('1.0.2', response)>0){
			...
			new Ajax( 'http://www.mobilejoomla.com/getver.php?v=' + escape('1.0.2'), {
				method: 'get',
				update: $('mjlatestver'),
