...
<div id="all">
    ...
    <div id="header-image">
      ...
      <?php if ($this->countModules('position-15')==0): ?>
        <a href="http://www.jak95.ru/coppermine/index.php?cat=23" target="_blank"> <img src="<?php echo $this->baseurl ?>/templates/<?php echo $this->template; ?>/images/travel.gif"  alt="<?php echo JText::_('TPL_BEEZ5_LOGO'); ?>" title="Ссылка на фотографии путешествия"</a>
      <?php endif; ?>
    </div>
    <?php if (!$templateparams->get('html5', 0)): ?>
      </div><!-- end header -->
