...
if ($article->showCreateDate)
    $params['metadata-header-icons'][] = JHTML::_('image.site', 'postdateicon.png', null, null, null, JText::_("postdateicon"), array('width' => '14', 'height' => '13')) . $article->createDateInfo();
if ($article->showModifyDate)
    $params['metadata-header-icons'][] = JHTML::_('image.site', 'postdateicon.png', null, null, null, JText::_("postdateicon"), array('width' => '14', 'height' => '13')) . $article->modifyDateInfo();
if ($article->showPublishDate)
    $params['metadata-header-icons'][] = JHTML::_('image.site', 'postdateicon.png', null, null, null, JText::_("postdateicon"), array('width' => '14', 'height' => '13')) . $article->publishDateInfo();
if ($article->showAuthor)
    $params['metadata-header-icons'][] = JHTML::_('image.site', 'postauthoricon.png', null, null, null, JText::_("postauthoricon"), array('width' => '14', 'height' => '14')) . $article->authorInfo();
