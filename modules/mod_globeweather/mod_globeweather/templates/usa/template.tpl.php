<?php
// GlobeWeather 1.3  module - build 110429	template.tpl
...
?>
<!--GlobeWeather for Joomla! 1.6/1.7 - 1.3.5 us - 15-Jan-2012 | 00:00 - <?php echo $_SESSION['metar_mode'].'/'; if(isset($_SESSION['metar_mode_actual'])) { echo $_SESSION['metar_mode_actual']; }?> - by www.innato.nl -->
...
<div style="font-family: arial, helvetica, sans-serif; font-size: medium; font-weight: bold; color: #ffff00;"><?php echo $temperature_f;?></div></td></tr>
...
<tr>
<td style="background-color:#cccccc; text-align:left; padding-left:2px; font-family: arial, helvetica, sans-serif; color: #000000;"><?php echo $language['Feels_Like'];?></td><td style="background-color:#aaaaaa; text-align:left; padding-left:2px; font-family: arial, helvetica, sans-serif; color: #000000;"><?php echo $windchill_f;?></td>
</tr>
<tr>
<td style="background-color:#cccccc; text-align:left; padding-left:2px; font-family: arial, helvetica, sans-serif; color: #000000;"><?php echo $language['Dew_Point'];?></td><td style="background-color:#aaaaaa; text-align:left; padding-left:2px; font-family: arial, helvetica, sans-serif; color: #000000;"><?php echo $dew_f;?></td>
</tr>
<tr>
...
<tr>
<td style="background-color:#cccccc; text-align:left; padding-left:2px; font-family: arial, helvetica, sans-serif; color: #000000;"><?php echo $language['Wind_Speed'];?></td><td style="background-color:#aaaaaa; text-align:left; padding-left:2px; font-family: arial, helvetica, sans-serif; color: #000000;"><?php echo $wind_miles_per_hour;?></td>
</tr>
<tr>
<td style="background-color:#cccccc; text-align:left; padding-left:2px; font-family: arial, helvetica, sans-serif; color: #000000;"><?php echo $language['Wind_Gust'];?></td><td style="background-color:#aaaaaa; text-align:left; padding-left:2px; font-family: arial, helvetica, sans-serif; color: #000000;"><?php echo $wind_gust_miles_per_hour;?></td>
</tr>
<tr>
<td style="background-color:#cccccc; text-align:left; padding-left:2px; font-family: arial, helvetica, sans-serif; color: #000000;"><?php echo $language['Visibility'];?></td><td style="background-color:#aaaaaa; text-align:left; padding-left:2px; font-family: arial, helvetica, sans-serif; color: #000000;"><?php echo $visibility_miles;?></td>
</tr>
<tr>
...
<tr>
<td style="background-color:#cccccc; text-align:left; padding-left:2px; font-family: arial, helvetica, sans-serif; color: #000000;"><?php echo $language['Humidity_Index'];?></td><td style="background-color:#aaaaaa; text-align:left; padding-left:2px; font-family: arial, helvetica, sans-serif; color: #000000;"><?php echo $humidex_f;?></td>
</tr>
<tr>
<td style="background-color:#cccccc; text-align:left; padding-left:2px; font-family: arial, helvetica, sans-serif; color: #000000;"><?php echo $language['Heat_Index'];?></td><td style="background-color:#aaaaaa; text-align:left; padding-left:2px; font-family: arial, helvetica, sans-serif; color: #000000;"><?php echo $heatindex_f;?></td>
</tr>
<tr>
<td style="background-color:#cccccc; text-align:left; padding-left:2px; font-family: arial, helvetica, sans-serif; color: #000000;"><?php echo $language['Precipitation'];?></td><td style="background-color:#aaaaaa; text-align:left; padding-left:2px; font-family: arial, helvetica, sans-serif; color: #000000;"><?php echo $precipitation_in;?></td>
</tr>
