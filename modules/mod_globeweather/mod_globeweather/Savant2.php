<?php
// Savant2 for GlobeWeather 1.1 module - build 110115
// (c)2011-2012 INNATO BV - www.innato.nl
// @license - http://www.gnu.org/licenses/gpl-2.0.html GNU/GPL
// **************************************************************************
// A metar station weather fetching module for Joomla! 1.6 by Innato B.V.
// **************************************************************************
...
* sure to donate! :-)
* 
* $Id: Savant2.php,v 1.2 2004/07/23 19:37:34 vasco Exp $
* 
...
class Savant2 {
	...
	*/
	...
	/**
	* 
	* Whether or not to extract assigned variables to local scope.
	* 
	* If this is set to false, you have to use "$this->varname" in your
	* templates to access a variable instead of "$varname".  This has
	* two benefits: speed (no time spend extracting variables), resource
	* use (saves RAM by not making new references to variables), and clarity
	* (any $this->varname is obviously an assigned var, and vars created within
	* the template are not prefixed with $this).
	* 
	* @access private
	* 
	* @var string
