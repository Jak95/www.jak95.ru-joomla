...
class YGPagination extends JObject
{
	...
	protected function _buildDataObject()
	{
		...
		$data->all = new JCBPaginationObject($Translations['all'], $this->prefix);
		if (!$this->_viewall) {
			$data->all->base	= '0';
		...
		$data->start	= new JCBPaginationObject($Translations['start'], $this->prefix);
		$data->previous	= new JCBPaginationObject($Translations['prev'], $this->prefix);
		...
		if ($this->get('pages.current') > 1)
		{
			...
			$data->start->base	= '0';
			$data->start->link	= $FullPath;//.$computed_prefix.'start=0';
		...
		$data->next	= new JCBPaginationObject($Translations['next'], $this->prefix);
		$data->end	= new JCBPaginationObject($Translations['end'], $this->prefix);
